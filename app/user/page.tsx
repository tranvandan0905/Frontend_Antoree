...
export default function HomePage() {
  ...
  return (
    <main>
      <section id="hero" className="text-center py-5 text-white" style={{ background: "linear-gradient(135deg, #353739ff, #615771ff)" }}>
        <Container>
          <h1>Biết Ngay Trình Độ TOEIC/IELTS Của Bạn Sau 15 Phút</h1>
          <p className="subtitle mb-4">
            Chấm dứt việc ôn thi lan man. Nhận ngay phân tích chi tiết điểm yếu và lộ trình học được cá nhân hóa.
          </p>
          <div className="hero-cta">
            <Link href="/user/home" className="btn btn-primary m-2">LÀM BÀI TEST MIỄN PHÍ</Link>
            <Link href="/user/learning" className="btn btn-secondary m-2">Khám phá lộ trình học</Link>
          </div>
      ...
      <section id="solution" className="py-5 bg-white">
        <Container>
          <h2 className="mb-5 text-center fw-bold">Tại Sao Luyện Thi Mãi Vẫn Không Tiến Bộ?</h2>
      ...
      <section id="testimonials" className="py-5 bg-light">
        <Container>
          <h2 className="mb-5 text-center fw-bold">Học Viên Của Chúng Tôi Đã Bứt Phá Như Thế Nào?</h2>
